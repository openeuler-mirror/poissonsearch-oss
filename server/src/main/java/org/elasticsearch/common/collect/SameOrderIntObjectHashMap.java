 ...
 * @since 2023-06-13
 */
public class SameOrderIntObjectHashMap<VType> extends IntObjectHashMap<VType> {
    /**
     * New instance with sane defaults.
     */
    public SameOrderIntObjectHashMap() {
        super();
    }
     ...
     */
    public SameOrderIntObjectHashMap(int expectedElements) {
     ...
     */
    public SameOrderIntObjectHashMap(int expectedElements, double loadFactor) {
     ...
     */
    public SameOrderIntObjectHashMap(IntObjectAssociativeContainer<? extends VType> container) {
        super(container);
    }

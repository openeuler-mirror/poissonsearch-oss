...
package java.org.elasticsearch.index.analysis;
...
public class PinyinAnalysisTest {
    ...
    public void TestTokenizer() throws IOException {
        String[] s = {
            "刘德华", "劉德華", "刘德华A1", "讲话频率小，不能发高音", "T波低平或倒置", "β-氨基酸尿", "DJ音乐家",
            "人生一大乐事, 哈哈",
        };
    ...
    private HashMap<String, ArrayList<TermItem>> getStringArrayListHashMap(String[] s, PinyinConfig config)
        throws IOException {
